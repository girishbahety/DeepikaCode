...
public class Owner {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(login).append(id).append(nodeId).append(avatarUrl).append(gravatarId).append(url).append(htmlUrl).append(followersUrl).append(followingUrl).append(gistsUrl).append(starredUrl).append(subscriptionsUrl).append(organizationsUrl).append(reposUrl).append(eventsUrl).append(receivedEventsUrl).append(type).append(siteAdmin).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(login, rhs.login).append(id, rhs.id).append(nodeId, rhs.nodeId).append(avatarUrl, rhs.avatarUrl).append(gravatarId, rhs.gravatarId).append(url, rhs.url).append(htmlUrl, rhs.htmlUrl).append(followersUrl, rhs.followersUrl).append(followingUrl, rhs.followingUrl).append(gistsUrl, rhs.gistsUrl).append(starredUrl, rhs.starredUrl).append(subscriptionsUrl, rhs.subscriptionsUrl).append(organizationsUrl, rhs.organizationsUrl).append(reposUrl, rhs.reposUrl).append(eventsUrl, rhs.eventsUrl).append(receivedEventsUrl, rhs.receivedEventsUrl).append(type, rhs.type).append(siteAdmin, rhs.siteAdmin).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
